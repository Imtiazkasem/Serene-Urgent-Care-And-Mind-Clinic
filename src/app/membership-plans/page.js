...
const MembershipPlansPage = () => {
  ...
  if (showPlans) {
    return <MembershipPlans setShowPlans={setShowPlans} planDetails={planDetails} />;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">
            Serene Care <span className="text-primary">Membership Program</span>
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {plans.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="absolute top-0 right-0 bg-third text-white px-4 py-1 text-sm font-semibold rounded-bl-lg">
                  Most Popular
                </div>
              )}
              ...
              <div className="p-6">
                ...
                {plan.familyAddon && (
                  <div className="bg-third/5 border border-third/20 rounded-lg p-3 mb-4">
                ...
                <button
                  ...
                  className="w-full py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary-hover transition cursor-pointer"
                >
                  Select Plan
                </button>
              </div>
